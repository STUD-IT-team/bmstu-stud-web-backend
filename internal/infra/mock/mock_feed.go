...
func (m *MockfeedServiceStorage) UpdateFeed(ctx context.Context, id int, feed domain.Feed) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateFeed", ctx, id, feed)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateFeed indicates an expected call of UpdateFeed.
func (mr *MockfeedServiceStorageMockRecorder) UpdateFeed(ctx, id, feed interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateFeed", reflect.TypeOf((*MockfeedServiceStorage)(nil).UpdateFeed), ctx, id, feed)
}
